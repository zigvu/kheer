...
class LeaguesControllerTest < ActionController::TestCase
  ...
  test "should create league" do
    assert_difference('League.count') do
      post :create, league: { cellroti_id: @league.cellroti_id, description: @league.description, name: @league.name, sport_id: @league.sport_id }
    end
  ...
  test "should update league" do
    patch :update, id: @league, league: { cellroti_id: @league.cellroti_id, description: @league.description, name: @league.name, sport_id: @league.sport_id }
    assert_redirected_to league_path(assigns(:league))
  end
