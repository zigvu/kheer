...
class SportsControllerTest < ActionController::TestCase
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post :create, sport: { cellroti_id: @sport.cellroti_id, description: @sport.description, name: @sport.name }
    end
  ...
  test "should update sport" do
    patch :update, id: @sport, sport: { cellroti_id: @sport.cellroti_id, description: @sport.description, name: @sport.name }
    assert_redirected_to sport_path(assigns(:sport))
  end
