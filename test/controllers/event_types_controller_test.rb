...
class EventTypesControllerTest < ActionController::TestCase
  ...
  test "should create event_type" do
    assert_difference('EventType.count') do
      post :create, event_type: { cellroti_id: @event_type.cellroti_id, description: @event_type.description, name: @event_type.name, sport_id: @event_type.sport_id, weight: @event_type.weight }
    end
  ...
  test "should update event_type" do
    patch :update, id: @event_type, event_type: { cellroti_id: @event_type.cellroti_id, description: @event_type.description, name: @event_type.name, sport_id: @event_type.sport_id, weight: @event_type.weight }
    assert_redirected_to event_type_path(assigns(:event_type))
  end
