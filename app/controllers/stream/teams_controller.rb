module Stream
  class TeamsController < ApplicationController
    ...
    def synch
      ...
      success, message = CellrotiData::Team.synch(
        @team, {league_id: @league.cellroti_id})
      if success
        redirect_to stream_league_url(@league), notice: 'Team : ' + message
      else
        redirect_to stream_league_url(@league), alert: 'Team : ' + message
      end
    end
