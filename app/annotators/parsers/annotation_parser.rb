module Annotators
	module Parsers
		class AnnotationParser
			...
			attr_accessor :annotations, :annotationIdentifier
			...
			def initialize(annotationParams)
				...
				@annotationIdentifier = {
					ci: annotationParams['chia_version_id'].to_i, 
					vi: annotationParams['video_id'].to_i, 
					fn: annotationParams['frame_number'].to_i
				}

				@annotations = []
				if annotationParams['annotations'] != nil
					annotationParams['annotations'].each do |annoId, a|
